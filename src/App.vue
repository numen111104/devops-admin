<template>
  <div class="min-h-screen">
    ...
    <!-- Mobile Overlay -->
    <div v-show="showMobileOverlay" @click="closeMobileSidebar" class="fixed inset-0 bg-black/50 z-30 lg:hidden"></div>

    <div class="flex h-screen">
      <Sidebar :is-collapsed="isSidebarCollapsed" :show-mobile="showMobileSidebar" @toggle="toggleSidebar"
        @close-mobile="closeMobileSidebar" />

      <!-- Improved responsive layout with better breakpoints -->
      <div class="flex-1 flex flex-col min-w-0 transition-all duration-300 ease-in-out overflow-hidden" :class="{
